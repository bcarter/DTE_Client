...
F(a)){var c=ta(a);b=b.concat(e(c.requires)).concat(c._runBlocks);try{for(var d=c._invokeQueue,c=0,f=d.length;c<f;c++){var g=d[c],h=g[0]=="$injector"?l:l.get(g[0]);h[g[1]].apply(h,g[2])}}catch(i){throw i.errorMessage&&(i.errorMessage+=" from "+a),i;}}else if(M(a))try{b.push(l.invoke(a))}catch(o){throw o.errorMessage&&(o.errorMessage+=" from "+a),o;}else if(K(a))try{b.push(l.invoke(a))}catch(n){throw n.errorMessage&&(n.errorMessage+=" from "+String(a[a.length-1])),n;}else ra(a,"module")});return b}function g(a,b){function c(d){if(typeof d!==
